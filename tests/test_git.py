...
@mock.patch("mozphab.git.Git.git_out")
@mock.patch("mozphab.git.Git.get_base_remote_args")
def test_get_latest_landing_node(mock_get_base_remote_args, m_git_out, git):
    mock_get_base_remote_args.return_value = ["--remotes=origin"]

    m_git_out.return_value = "sha222"
...
@mock.patch("mozphab.git.Git.git_out")
@mock.patch("mozphab.git.Git.get_base_remote_args")
def test_get_latest_landing_node_before(mock_get_base_remote_args, m_git_out, git):
    mock_get_base_remote_args.return_value = ["--remotes=origin"]
    m_git_out.return_value = "sha222"
